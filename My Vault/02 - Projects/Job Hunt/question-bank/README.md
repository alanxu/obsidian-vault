...
scope: "Self-contained practical/OO coding problems (master-plan Track B §3). Delivery-channel-agnostic."
location: "Top-level (outside track folders) — shared resource."
...
2. Re-implement from a blank file, **timed, in a bare web editor** (not your IDE) — [[practical-oo-coding-deep-guide]] §6.5.
3. Read the **"By format"** section for the format your target company uses (see each file's `companies`/`formats`), and rehearse those follow-ups.
...
*Merged & relocated 2026-06-16. Canonical home for practical/OO coding questions; Tracks B and G point here.*
